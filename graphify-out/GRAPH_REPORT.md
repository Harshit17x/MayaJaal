...
## Summary
- 1315 nodes · 2127 edges · 93 communities (56 shown, 27 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 35 edges (avg confidence: 0.9)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bd93caf0`
...
Cohesion: 0.09
Nodes (13): CameraFeedStrip(), cameras, RecentAlerts(), SystemStatus(), AlertFilter, AlertItem, AlertSeverity, GlobalTraceItem (+5 more)
...
Cohesion: 0.11
Nodes (22): GeofencesPage(), GisMapPage(), CameraCard(), CameraCardProps, CameraGrid(), AlertListener, alertsStore, ConnectionListener (+14 more)
...
### Community 43 - "useBackendStatus.ts"
Cohesion: 0.23
...
Cohesion: 0.18
Nodes (9): ONNXEngineError, ONNXInferenceError, Exception, ndarray, Run inference using a NumPy array. Preprocessing is intentionally kept outside…, Base exception for ONNX engine errors., Raised when inference fails., Configure application-wide logging. Logs are written to both: - the console - a… (+1 more)
...
## Knowledge Gaps
- **206 isolated node(s):** `CameraCardProps`, `DetectionCanvasProps`, `CLASS_COLORS`, `StreamValidationResult`, `CameraHealthStats` (+201 more)
...
- **Why does `ANPRPipeline` connect `ANPRPipeline` to `ONNXEngine`, `stream.py`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `ONNXEngine` connect `ONNXEngine` to `ANPRPipeline`, `ModelManagerError`, `stream.py`, `ModelManager`, `ONNXModelError`, `logging.py`?**
