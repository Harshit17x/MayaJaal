...
## Summary
- 1131 nodes · 1813 edges · 82 communities (50 shown, 13 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 41 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ebee202e`
...
6. `ByteTrackerWrapper` - 17 edges
7. `useAlerts()` - 17 edges
8. `RTSPStream` - 16 edges
...
Cohesion: 0.06
Nodes (42): api_route, _build_tracker_config(), _create_preprocessor(), get_annotated_frame(), get_annotated_video(), get_global_trace_trajectory(), _get_model_input_size(), list_global_traces() (+34 more)

### Community 10 - "logging.py"
Cohesion: 0.06
Nodes (46): create_standby_frame(), draw_bounding_boxes(), draw_tactical_hud(), get_live_stream(), get_snapshot(), is_host_reachable(), is_rtsp_host_reachable(), normalize_stream_url() (+38 more)
...
### Community 60 - "get"
Cohesion: 0.05
Nodes (53): get(), acknowledge_alert(), AlertCreateRequest, alerts_websocket_endpoint(), clear_alerts(), create_alert(), dispatch_qrt(), get_alert_snapshot() (+45 more)
...
## Knowledge Gaps
- **175 isolated node(s):** `SuspectTrajectoryModalProps`, `StreamValidationResult`, `AlertFilter`, `SuspectWaypoint`, `OperatorUser` (+170 more)
...
- **Why does `ONNXEngine` connect `ONNXEngine` to `ModelManagerError`, `ANPRPipeline`, `logging.py`, `ModelManager`, `ONNXModelError`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `react` connect `react` to `useAuth`, `frontend/package.json`, `camerasStore.ts`, `lucide-react`, `alertsStore.ts`, `liveworkspace.tsx`, `AnalyticsDashboard.tsx`, `facial-recognition/page.tsx`, `alerts/page.tsx`, `api.ts`?**
...
- **What connects `SuspectTrajectoryModalProps`, `StreamValidationResult`, `AlertFilter` to the rest of the system?**
