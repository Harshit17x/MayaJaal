...
Cohesion: 0.11
Nodes (25): _build_tracker_config(), _create_preprocessor(), _get_model_input_size(), Any, post, UploadFile, /api/tracking — ByteTrack multi-object tracking endpoints. Endpoints ---------…, Run ByteTrack multi-object tracking on an uploaded video. A **fresh** tracker… (+17 more)
...
Cohesion: 0.18
Nodes (16): NavItem, OperatorLayout(), TacticalThreatToast(), AlertListener, ConnectionListener, connectionListeners, getAlertsWsUrl(), INITIAL_ALERTS (+8 more)

### Community 25 - "gis-map/page.tsx"
Cohesion: 0.24
Nodes (6): GisMapPage(), CameraFeedStrip(), cameras, RecentAlerts(), SystemStatus(), AlertSeverity
...
### Community 68 - "get"
Cohesion: 0.12
Nodes (16): get(), websocket, websocket_endpoint(), get_alert_snapshot(), Serve forensic snapshot JPEG image for an alert., get_plate_snapshot(), get_processed_video(), Response (+8 more)
...
Cohesion: 0.23
Nodes (11): lifespan(), Exception, unexpected_exception_handler(), validation_exception_handler(), Configure application-wide logging. Logs are written to both: - the console - a…, setup_logging(), exception_handler, FastAPI (+3 more)

### Community 74 - "useBackendStatus"
Cohesion: 0.29
Nodes (5): MetricCard(), MetricCardProps, MetricsRow(), ConnectionStatus(), useBackendStatus()
...
## Knowledge Gaps
- **173 isolated node(s):** `config`, `nextConfig`, `name`, `version`, `private` (+168 more)
...
- **Why does `RTSPStream` connect `RTSPStream` to `tracking.py`, `RTSPError`, `inference.py`?**
