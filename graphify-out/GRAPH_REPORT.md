...
### Community 33 - "PostprocessorError"
Cohesion: 0.67
...
### Community 36 - "get_logger"
Cohesion: 0.67
Nodes (3): get_logger(), Return a logger for a specific application module., Logger
...
## Knowledge Gaps
- **190 isolated node(s):** `config`, `nextConfig`, `name`, `version`, `private` (+185 more)
