...
Cohesion: 0.11
Nodes (9): CameraFeedStrip(), cameras, MetricCard(), MetricCardProps, MetricsRow(), SystemStatus(), ConnectionStatus(), useBackendStatus() (+1 more)
...
### Community 22 - "api.ts"
Cohesion: 0.09
Nodes (33): COLOR_PRESETS, FeedViewMode, ToolMode, ApiError, request(), StreamValidationResult, BackendStatusState, HealthResponse (+25 more)
...
Cohesion: 0.13
Nodes (20): GisMapPage(), RecentAlerts(), AlertListener, alertsStore, ConnectionListener, connectionListeners, getAlertsWsUrl(), INCIDENT_STORAGE_KEY (+12 more)
...
Cohesion: 0.12
Nodes (23): AlertsPage(), NavItem, TacticalThreatToast(), SuspectTrajectoryModal(), SuspectTrajectoryModalProps, CLASS_COLORS, DetectionCanvas(), DetectionCanvasProps (+15 more)
...
- **Why does `RTSPStream` connect `RTSPStream` to `tracking.py`, `inference.py`, `RTSPError`?**
