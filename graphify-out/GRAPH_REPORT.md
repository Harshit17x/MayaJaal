...
Cohesion: 0.18
Nodes (12): COLOR_PRESETS, GeofencesPage(), ToolMode, CreateTripwirePayload, CreateZonePayload, DirectionalTripwire, GeofenceBreachEvent, GeofenceEvaluateResponse (+4 more)
...
Cohesion: 0.06
Nodes (47): create_preprocessor(), get_model_input_size(), image_inference(), post, UploadFile, Run bounded inference on frames from an uploaded video., Get the preferred (width, height) resolution for a model. Defaults to (640,…, Create the preprocessing pipeline with model-specific input resolution. (+39 more)

### Community 11 - "useBackendStatus.ts"
Cohesion: 0.23
Nodes (8): MetricCard(), MetricCardProps, MetricsRow(), ConnectionStatus(), BackendStatusState, useBackendStatus(), HealthResponse, InferenceStatusResponse
...
Cohesion: 0.19
Nodes (10): AlertsPage(), RecentAlerts(), AlertFilter, AlertItem, AlertSeverity, GlobalTraceItem, QrtDispatchRecord, ScannerStatus (+2 more)
...
Cohesion: 0.06
Nodes (36): create_standby_frame(), draw_bounding_boxes(), draw_tactical_hud(), get_live_stream(), get_snapshot(), is_host_reachable(), is_rtsp_host_reachable(), normalize_stream_url() (+28 more)
...
### Community 60 - "get"
Cohesion: 0.05
Nodes (55): get(), acknowledge_alert(), AlertCreateRequest, alerts_websocket_endpoint(), clear_alerts(), create_alert(), dispatch_qrt(), get_alert_snapshot() (+47 more)
...
Cohesion: 0.29
Nodes (6): websocket, websocket_endpoint(), lifespan(), get, root(), FastAPI
...
Cohesion: 0.14
Nodes (19): NavItem, OperatorLayout(), TacticalThreatToast(), CameraGrid(), AlertListener, alertsStore, ConnectionListener, connectionListeners (+11 more)
...
## Knowledge Gaps
- **182 isolated node(s):** `ToolMode`, `COLOR_PRESETS`, `DEMO_ALERT`, `NeighborBorder`, `NEIGHBOR_BORDERS` (+177 more)
...
- **What connects `ToolMode`, `COLOR_PRESETS`, `DEMO_ALERT` to the rest of the system?**
