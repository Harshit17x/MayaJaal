...
## Corpus Check
- 140 files · ~1,999,157 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1384 nodes · 2279 edges · 80 communities (58 shown, 12 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 38 edges (avg confidence: 0.9)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bf4b5f64`
...
9. `ThermalFusionService` - 17 edges
...
- `process_thermal_video()` --calls--> `VideoLoader`  [INFERRED]
  backend/app/api/thermal.py → backend/app/pipeline/video_loader.py
- `process_thermal_video()` --calls--> `convert_video_to_h264()`  [INFERRED]
  backend/app/api/thermal.py → backend/app/tracking/annotator.py
...
### Community 3 - "facial-recognition/page.tsx"
Cohesion: 0.31
...
Cohesion: 0.06
Nodes (39): CAMERA_TYPES, CamerasPage(), COORDINATE_PRESETS, SECTORS, BorderMap(), BorderMapProps, DEMO_ALERT, escapeHtml() (+31 more)
...
Cohesion: 0.18
Nodes (21): CameraCreateRequest, CameraUpdateRequest, create_camera(), delete_camera(), _ensure_data_file(), HealthStats, _load_cameras(), _load_default_cameras_from_file() (+13 more)
...
Cohesion: 0.06
Nodes (43): _build_tracker_config(), _create_preprocessor(), get_annotated_frame(), get_annotated_video(), get_global_trace_trajectory(), _get_model_input_size(), list_global_traces(), list_rtsp_sessions() (+35 more)
...
Cohesion: 0.08
Nodes (39): batch_inference(), create_preprocessor(), get_model_input_size(), image_inference(), inference_status(), get, post, UploadFile (+31 more)
...
### Community 18 - "react"
Cohesion: 0.29
Nodes (4): MetricCard(), MetricCardProps, MetricsRow(), react
...
Cohesion: 0.14
Nodes (17): ConnectionStatus(), CameraCard(), CameraCardProps, CameraGrid(), CLASS_COLORS, DetectionCanvas(), DetectionCanvasProps, buildStreamUrl() (+9 more)

### Community 23 - "lucide-react"
Cohesion: 0.12
Nodes (6): GisMapPage(), CameraFeedStrip(), cameras, SystemStatus(), GlobalTraceItem, lucide-react
...
Cohesion: 0.17
Nodes (18): NavItem, TacticalThreatToast(), AlertListener, ConnectionListener, connectionListeners, getAlertsWsUrl(), INCIDENT_STORAGE_KEY, initWebSocket() (+10 more)
...
### Community 33 - "api.ts"
Cohesion: 0.11
Nodes (25): AnprPage(), ApiError, request(), StreamValidationResult, BackendStatusState, QrtDispatchRecord, AnprRecord, AnprScanResponse (+17 more)
...
### Community 45 - "get_camera"
Cohesion: 0.40
Nodes (5): get_camera(), get_cameras(), get, Get all registered camera nodes with optional filtering., Get a single camera node by ID.
...
### Community 78 - "alert.ts"
Cohesion: 0.21
Nodes (12): AlertsPage(), RecentAlerts(), SuspectTrajectoryModal(), SuspectTrajectoryModalProps, api, formatConfidence(), AlertFilter, AlertItem (+4 more)
...
## Knowledge Gaps
- **206 isolated node(s):** `StreamValidationResult`, `NavItem`, `DayData`, `OutpostItem`, `CategoryStat` (+201 more)
...
- **Why does `ONNXEngine` connect `ONNXEngine` to `ANPRPipeline`, `ModelManagerError`, `logging.py`, `ONNXModelError`, `ModelManager`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `get_logger()` connect `FastAPI` to `auth.py`, `logging.py`, `cameras.py`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `ModelManager` connect `ModelManager` to `ModelManagerError`, `ONNXEngine`, `ONNXModelError`, `ResourceManager`, `inference_service.py`?**
...
- **What connects `StreamValidationResult`, `NavItem`, `DayData` to the rest of the system?**
